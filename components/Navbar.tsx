  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-[100] px-6 md:px-10 pointer-events-none">
      <div className="max-w-full mx-auto flex justify-between items-start pointer-events-auto py-8">
        ...
        {/* LEFT: LOGO - 직선적이고 견고한 폰트 적용 (왜곡 제거) */}
        ...
        {/* CENTER HUD - 장식용 HUD 요소 */}
        <div className="hidden xl:flex flex-col items-center gap-1 mt-2">
          <div className="flex items-center gap-4">
             <div className="w-10 h-[1px] bg-gradient-to-r from-transparent via-cyan-500/20 to-transparent"></div>
             <span className="font-mono text-[9px] text-cyan-500/40 font-black tracking-[0.6em] uppercase">
               NEURAL _ ARCHITECT _ ID : 01
             </span>
             <div className="w-10 h-[1px] bg-gradient-to-l from-transparent via-cyan-500/20 to-transparent"></div>
          </div>
        </div>
        
        {/* RIGHT: CONNECT BUTTON */}
        <div className="flex flex-col items-end gap-3">
           <div className="hidden md:flex flex-col items-end gap-0.5 font-mono text-[8px] tracking-widest uppercase opacity-40">
